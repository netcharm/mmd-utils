...
class MainForm ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.menuResetCamera = wx.MenuItem( self.menuTool, wx.ID_ANY, _(u"Reset Camera"), wx.EmptyString, wx.ITEM_DROPDOWN )
		...
		self.btnResetCamera = self.toolbar.AddLabelTool( ID_GRIDPLANE, _(u"Reset Camera"), wx.Bitmap( u"icons/layers.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_DROPDOWN, wx.EmptyString, wx.EmptyString, None )
